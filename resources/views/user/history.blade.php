...
:root {
    ...
    --sidebar-bg-color: #ffffff; /* Nền sidebar trắng */
    --sidebar-border-color: #e9ecef; /* Viền sidebar nhạt */
    --tab-inactive-bg: #e9ecef; /* Nền tab không active */
    --tab-inactive-text: #6c757d; /* Màu chữ tab không active */
}

/* Kiểu dáng chung cho body và font */
body {
    font-family: 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
    background-color: var(--light-background-color); /* Nền trang màu xám nhẹ */
...
.container {
    max-width: 1200px; /* Chiều rộng tối đa cho container lớn */
    margin: 40px auto; /* Khoảng cách trên dưới */
}
...
.breadcrumb-item.active {
    color: var(--secondary-color); /* Màu xám cho item active */
    font-weight: 600;
}

/* Sidebar */
.sidebar {
    background-color: var(--sidebar-bg-color); /* Nền trắng cho sidebar */
    border: 1px solid var(--sidebar-border-color); /* Viền nhạt */
...
.sidebar a {
    display: flex;
    align-items: center;
    padding: 15px 10px; /* Tăng padding item */
    color: var(--text-color); /* Màu chữ mặc định */
    text-decoration: none;
    font-size: 17px; /* Kích thước font */
    border-radius: 8px; /* Bo tròn item */
...
.sidebar a i {
    ...
    color: var(--secondary-color); /* Màu icon mặc định */
    transition: color 0.3s ease;
}

.sidebar a:hover {
    background-color: var(--light-background-color); /* Nền nhẹ khi hover */
    color: var(--primary-color); /* Màu chữ xanh khi hover */
}

.sidebar a:hover i {
    color: var(--primary-color); /* Màu icon xanh khi hover */
}

.sidebar a.active {
    background-color: var(--primary-color); /* Nền xanh khi active */
    color: #ffffff; /* Chữ trắng khi active */
    font-weight: 600;
    box-shadow: 0 2px 8px rgba(0, 123, 255, 0.2); /* Đổ bóng nhẹ cho active */
}
...
/* Tab Container */
.tab-container {
    background-color: var(--container-background-color); /* Nền trắng cho tab container */
    border: 1px solid var(--border-color); /* Viền nhạt */
    border-radius: 12px; /* Bo tròn góc */
    overflow: hidden;
    display: flex;
    margin-bottom: 25px; /* Khoảng cách dưới tab */
...
.tab-btn {
    ...
    font-size: 18px;
    cursor: pointer;
    border-right: 1px solid var(--border-color); /* Viền phải cho các nút tab */
    background-color: var(--tab-inactive-bg); /* Nền xám nhạt cho tab không active */
    color: var(--tab-inactive-text); /* Màu chữ xám cho tab không active */
    font-weight: 500;
    transition: all 0.3s ease; /* Hiệu ứng chuyển động */
}
...
.tab-btn:hover:not(.active) {
    background-color: #f3f3f3; /* Nền nhạt hơn khi hover */
...
.tab-btn.active {
    color: var(--primary-color);
    font-weight: 700;
    background-color: var(--container-background-color); /* Nền trắng cho tab active */
    border-bottom: 3px solid var(--primary-color); /* Thanh dưới màu xanh */
    box-shadow: inset 0 -3px 0 0 var(--primary-color); /* Đổ bóng dưới để tạo hiệu ứng thanh */
    border-radius: 12px 12px 0 0; /* Bo tròn góc trên */
}

/* Tab Content Section */
.tab-content-section {
    background-color: var(--container-background-color); /* Nền trắng cho nội dung tab */
